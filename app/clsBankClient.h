...
private:
    ...
    static stTransferLogRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferLog.AccountNumberSourceClient = TransferLogDataLine[1];
        TransferLog.AccountNumberDestinationClient = TransferLogDataLine[2];
        TransferLog.BalanceTransfer = stof(TransferLogDataLine[3]);
        TransferLog.BalanceSourceClient = stof(TransferLogDataLine[4]);
        TransferLog.BalanceDestinationClient = stof(TransferLogDataLine[5]);
...
public:
    ...
    struct stTransferLogRecord
    {
        ...
        float BalanceSourceClient;
        float BalanceDestinationClient;
        string UserName;
    };
